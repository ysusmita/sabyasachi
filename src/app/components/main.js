...
export default function Main() {
  ...
  return (
    <>
      ...
      >
                <div className=" hidden md:block  ">
          <img src="assets/banner/Group 1000001315.png" className="w-full h-screen" />
        </div>
        <div className=" block md:hidden">
      ...
      >
                <div className=" hidden md:block  ">
          <img src="assets/banner/Group 1000001316.png" className="w-full h-screen" />
        </div>
        <div className=" block md:hidden">
      ...
      >
                <div className=" hidden md:block  ">
          <img src="assets/banner/Group 1000001317.png" className="w-full h-screen" />
        </div>
        <div className=" block md:hidden">
